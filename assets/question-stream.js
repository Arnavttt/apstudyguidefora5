  ...
  function Stream(mount, courseId, framework, bank) {
    ...
    function providerLabel(provider) {
      return provider === 'ollama' ? 'Ollama local'
        ...
        : provider === 'openai' ? 'OpenAI' : 'AI-generated';
    }
    function updateSourceNote(source, provider) {
      ...
      var label = source === 'ai' ? providerLabel(provider)
        ...
        : source === 'cache' ? 'AI-cached'
        : 'Seeded fallback';
      note.textContent = label;
      note.title = source === 'ai'
        ? 'This question was generated by ' + providerLabel(provider) + '.'
        : source === 'seeded' ? 'Loaded from the built-in local practice bank.'
        : label;
    }
